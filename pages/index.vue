...
function goScroll(ar: string) {
  ...
  if (process.client) {
    ...
    if (ar == "home") {
      ...
      const elementPosition = document.getElementById(
        ar
      ) as HTMLInputElement | null;
      // console.log('!!!goScroll elementPosition '+elementPosition);
      // ----------------------start-----------------------
      const elementPosition2 = document.getElementById(
        "header_layout"
      ) as HTMLInputElement | null;
      ...
      if (elementPosition != null && elementPosition2 != null) {
        count =
          elementPosition.offsetTop - elementPosition2.offsetHeight + indent;
        window.scrollTo({
